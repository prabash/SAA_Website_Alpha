...
namespace TEST_ASP_ALPHA_1
{
    public partial class BrowseTvSeriesGrid : System.Web.UI.Page
    {
        ...
        {
            var slideShowDetails = new ItemsModel().GetSlideShowDetails(ItemType.TvSeries);
        ...
        {
            var gridDetails = new ItemsModel().GetItemDetails(ItemType.TvSeries, ItemSortBy.NameAsc, 18);
