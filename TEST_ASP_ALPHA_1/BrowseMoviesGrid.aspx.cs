...
namespace TEST_ASP_ALPHA_1
{
    public partial class BrowseMoviesGrid : System.Web.UI.Page
    {
        ...
        {
            var slideShowDetails = new ItemsModel().GetSlideShowDetails(ItemType.Movies);
        ...
        {
            var gridDetails = new ItemsModel().GetItemDetails(ItemType.Movies, ItemSortBy.NameAsc, 18);
