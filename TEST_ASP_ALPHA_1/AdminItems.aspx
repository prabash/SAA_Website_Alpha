...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        jQuery("#jQGridDemo").jqGrid({
            ...
            colModel: [
                        { name: 'Id', index: 'Id', width: 50, stype: 'text', search: true, sortable: true, sorttype: "int"},
                        ...
                        { name: 'regularPrice', index: 'regularPrice', width: 100, search: true, editable: true, sorttype: "double", },
                        { name: 'currentPrice', index: 'currentPrice', width: 100, search: true, editable: true, sorttype: "double" },
                        ...
                        { name: 'rating', index: 'rating', width: 110, search: true, editable: true, sorttype: "double" },
