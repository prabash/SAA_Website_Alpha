<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BrowseElectronicsGrid.aspx.cs" Inherits="TEST_ASP_ALPHA_1.BrowseElectronicsGrid" MasterPageFile="~/Site.Master" %>
        ...
        <div class="container">
            <div class="row">
                <ul>
                    ...
                    <li class="category13"><strong>Electronics</strong></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <section class="col-sm-9 col-sm-push-3">
                    <div class="col-main">
                        ...
                        <div class="category-products">
                            <div class="toolbar">
                                <div class="sorter">
                                    <div class="view-mode"><span title="Grid" class="button button-active button-grid">Grid</span><a href="#" onclick="navigateWithParam('BrowseElectronicsGrid', 'BrowseElectronicsList');" title="List" class="button button-list">List</a> </div>
                                </div>
                                <div id="sort-by">
                ...
                <aside class="col-left sidebar col-sm-3 col-xs-12 col-sm-pull-9 wow bounceInUp animated">
                    ...
                    <div class="block block-cart">
                        ...
                        <div class="block-content">
                            ...
                            <ul>
                                <li class="item"><a class="product-image" title="Fisher-Price Bubble Mower" href="product_detail.html">
                                    <img width="80" alt="product-image" src="products_images/product1.jpg"></a>
                                ...
                                <li class="item last"><a class="product-image" title="Prince Lionheart Jumbo Toy Hammock" href="product_detail.html">
                                    <img width="80" alt="product-image" src="products_images/product1.jpg"></a>
                                    <div class="product-details">
                                        <div class="access"><a class="btn-remove1" title="Remove This Item" href="#"><span class="icon"></span>Remove </a></div>
                                        <p class="product-name"><a href="product_detail.html">Sample Product</a> </p>
