        ...
        <div class="col-main">
          ...
          <div class="category-description std">
           ...
           <div class="category-products">
            <div class="toolbar">
              <div class="sorter">
                <div class="view-mode"> <span title="Grid" class="button button-active button-grid">Grid</span><a href="#" onclick="navigateWithParam('BrowseMoviesGrid', 'BrowseMoviesList');" title="List" class="button button-list">List</a> </div>
              </div>
              <div id="sort-by">
