<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BrowseTvSeriesList.aspx.cs" Inherits="TEST_ASP_ALPHA_1.BrowseTvSeriesList" MasterPageFile="~/Site.Master"%>
      ...
      <div class="row">
        ...
        <div class="col-main">
          ...
          <div class="category-products">
            <div class="toolbar">
              <div class="sorter">
                <div class="view-mode"> <a href="#" onclick="navigateWithParam('BrowseTvSeriesList','BrowseTvSeriesGrid');" title="Grid" class="button button-grid">Grid</a>&nbsp; <span title="List" class="button button-active button-list">List</span>&nbsp; </div>
              </div>
              <div id="sort-by">
