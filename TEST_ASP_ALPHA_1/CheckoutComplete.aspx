<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckoutComplete.aspx.cs" Inherits="TEST_ASP_ALPHA_1.CheckoutComplete"  MasterPageFile="~/Site.Master" %>
            ...
            <div class="row">
                <section class="col-main col-sm-9">
                    <div class="static-contain" runat="server" ID="successActMsgBox" visible="false">
                        ...
                        <br />
                        <p>Thank you for shopping with us! We'll be dispatching your order as soon as possible!</p>
                        <p>You can pay us when we deliver! <b>Currently we only accept cash</b>, but we are doing all we can to make your life easy in the future :)</p>
                        <p>Please subscribe to us to get to know more about latest Games, Movies, TV Series & deals!</p>
                        <br />
                    ...
                    <div class="static-contain" runat="server" ID="errorActMsgBox" visible="false">
                        ...
                        <br />
                        <p style="color:red" runat="server" id="paraError">An error occurred when trying to complete your order! Please try again later.</p>
                        <br />
                        <p>Please feel free to talk to us whenever you want, we are always there to help.</p>
                        <p><b>Address &nbsp;&nbsp;&nbsp;: </b>387/E, Galle Road, Ratmalana.</p>
                        <p><b>Telephone : </b>0115929266 / 0115929267</p>
