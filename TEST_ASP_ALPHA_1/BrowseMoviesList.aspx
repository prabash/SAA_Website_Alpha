<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BrowseMoviesList.aspx.cs" Inherits="TEST_ASP_ALPHA_1.BrowseMoviesList" MasterPageFile="~/Site.Master" %>
      ...
      <div class="row">
        ...
        <div class="col-main">
          ...
          <div class="category-products">
            <div class="toolbar">
              <div class="sorter">
                <div class="view-mode"> <a href="#" onclick="navigateWithParam('BrowseMoviesList','BrowseMoviesGrid');" title="Grid" class="button button-grid">Grid</a>&nbsp; <span title="List" class="button button-active button-list">List</span>&nbsp; </div>
              </div>
              <div id="sort-by">
