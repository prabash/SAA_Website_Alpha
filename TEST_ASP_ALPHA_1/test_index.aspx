<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test_index.aspx.cs" Inherits="TEST_ASP_ALPHA_1.test_index" %>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-5 col-sm-4 col-md-5">
          <!-- Header Logo -->
          <a class="logo" title="{{titleValue}}" href="index.html"><img alt="{{titleValue}}" src="images/logo.png"></a>
          <!-- End Header Logo -->
        </div>
          ...
          <li class="level0 nav-6 level-top parent"> <a href="grid.html" class="level-top"> <span>Electronics</span> <span class="category-label">New</span></a>
            <div style="display: none; left: 0px;" class="level0-wrapper dropdown-6col">
              <div class="level0-wrapper2">
                ...
                <div class="nav-block nav-block-right std grid12-3"> <a class="product-image" title="Stablished fact reader" href="#"> <img alt="Product image" src="products_images/product1.jpg" width="150"></a>
...
<div class="the-slideshow slideshow-wrapper">
    <ul class="slideshow" style="overflow: hidden;">
        <li class="slide">
            <p><a href="#"> <img src="images/banner-img-1.png" alt="Banner Image" /></a></p>
            <div class="caption light1 top-right">
                <div class="caption-inner">
                    <!--<p class="heading">Women Collection 2014</p>
                    <p class="heading1">GTA V</p>
                    <p class="heading">GTA V</p>-
                    <p class="intro-btn"><a title="Click to see all features" href="#">Shop Now</a></p>-->
                </div>
            </div>
        </li>
        <li class="slide">
            <p><a href="#"> <img src="images/banner-img-2.png" alt="Banner Image1" /></a></p>
            <div class="caption light1 top-right">
                <div class="caption-inner">
                    <!--<h2 class="heading">You like this theme?</h2>
                    <p class="heading">Witcher 3</p>
                    <p class="intro-btn"><a title="Click to see all features" href="#">Buy Now</a></p>-->
                </div>
            </div>
        </li>
        <li class="slide">
            <p><a title="#" href="#"> <img src="images/banner-img-3.png" alt="Banner Image"/> </a></p>
            <div class="caption light1 top-right">
                <div class="caption-inner">
                  <!--<p class="heading">Assassin's Creed - Syndicate</p>
                  <p class="intro-btn"><a title="Click to see all features" href="#">Buy Now</a></p>-->
              </div>
          </div>
      </li>
                  ...
                  <div class="slider-items slider-width-col4">
                          ...
                          <div class="item-inner">
                              <div class="product-block">
                                  <div class="product-image"> <a href="product_detail.html">
                                      <figure class="product-display">
                                          ...
                                          <img src="products_images/avengers-img.png" class="lazyOwl product-mainpic" alt="product-image" style="display: block;"> <img class="product-secondpic" alt="product-image" src="products_images/avengers-alt-img.png"> </figure>
                                  </a> </div>
                              ...
                              <div class="item-info">
                                  <div class="info-inner">
                                      <div class="item-title"> <a href="product_detail.html" title="Retis lapen casen"> Avengers - Age of Ultron</a> </div>
                                      <div class="item-content">
                                          <div class="item-price">
                                              <div class="price-box"> <span class="regular-price"> <span class="price">Rs.150.00</span> </span> </div>
                                          </div>
                                          <div class="rating">
                                              <div class="ratings">
                      ...
                      <div class="item">
                          <div class="item-inner">
                                  ...
                                  <div class="product-block">
                                      <div class="product-image"> <a href="product_detail.html">
                                          <figure class="product-display">
                                              ...
                                              <img src="products_images/starwars-img.png" class="lazyOwl product-mainpic" alt="product-image" style="display: block;"> <img class="product-secondpic" alt="product-image" src="products_images/starwars-img.png"> </figure>
                                      </a> </div>
                                      <div class="product-meta">
                                          <div class="product-action"> <a class="addcart" href="shopping_cart.html"> <i class="icon-shopping-cart">&nbsp;</i> Add to cart </a> <a class="wishlist" href="wishlist.html"> <i class="icon-heart">&nbsp;</i> </a> <a href="quick_view.html" class="quickview"> <i class="icon-zoom">&nbsp;</i> </a> </div>
                                      </div>
                              ...
                              <div class="item-info">
                                  <div class="info-inner">
                                      <div class="item-title"> <a href="product_detail.html" title="Ut tincidunt tortor"> Star Wars - The Force Awakens</a> </div>
                                      <div class="item-content">
                                          <div class="item-price">
                                              <div class="price-box">
                                                  <p class="old-price"> <span class="price-label">Regular Price:</span> <span class="price"  > Rs.500.00 </span> </p>
                                                  <p class="special-price"> <span class="price-label">Special Price</span> <span class="price"  > Rs.350.00 </span> </p>
                                              </div>
                                          </div>
                                          <div class="rating">
                                              <div class="ratings">
                      ...
                      <div class="item">
                          <div class="item-inner">
                              <div class="item-img">
                                  <div class="product-block">
                                      <div class="product-image"> <a href="product_detail.html">
                                          <figure class="product-display">
                                              <div class="new-label new-top-left">New</div>
                                              <img src="products_images/jurassicworld-img.png" class="lazyOwl product-mainpic" alt="Product image" style="display: block;"> <img class="product-secondpic" alt="Product image" src="products_images/jurassicworld-img.png"> </figure>
                                      </a> </div>
                                      <div class="product-meta">
                                          <div class="product-action"> <a class="addcart" href="shopping_cart.html"> <i class="icon-shopping-cart">&nbsp;</i> Add to cart </a> <a class="wishlist" href="wishlist.html"> <i class="icon-heart">&nbsp;</i> </a> <a href="quick_view.html" class="quickview"> <i class="icon-zoom">&nbsp;</i> </a> </div>
                                      </div>
                              ...
                              <div class="item-info">
                                  <div class="info-inner">
                                      <div class="item-title"> <a href="product_detail.html" title="Ut tincidunt tortor"> Jurassic World</a> </div>
                                      <div class="item-content">
                                          <div class="item-price">
                                              <div class="price-box">
                                                  <p class="old-price"> <span class="price-label">Regular Price:</span> <span class="price"  > Rs.500.00  </span> </p>
                                                  <p class="special-price"> <span class="price-label">Special Price</span> <span class="price"  > Rs.250.00  </span> </p>
                                              </div>
                                          </div>
                                          <div class="rating">
                                              <div class="ratings">
                          ...
                          <div class="item-inner">
                              <div class="product-block">
                                  <div class="product-image"> <a href="product_detail.html">
                                      <figure class="product-display">
                                          <div class="new-label new-top-left">New</div>
                                          <img src="products_images/terminator-img.png" class="lazyOwl product-mainpic" alt="Product image" style="display: block;"> <img class="product-secondpic" alt="Product image" src="products_images/terminator-img.png"> </figure>
                                  </a> </div>
                                  <div class="product-meta">
                                      <div class="product-action"> <a class="addcart" href="shopping_cart.html"> <i class="icon-shopping-cart">&nbsp;</i> Add to cart </a> <a class="wishlist" href="wishlist.html"> <i class="icon-heart">&nbsp;</i> </a> <a href="quick_view.html" class="quickview"> <i class="icon-zoom">&nbsp;</i> </a> </div>
                                  </div>
                              ...
                              <div class="item-info">
                                  <div class="info-inner">
                                      <div class="item-title"> <a href="product_detail.html" title="Stablished fact reader"> Terminator - Genisys</a> </div>
                                      <div class="item-content">
                                          <div class="item-price">
                                              <div class="price-box">
                                                  <p class="old-price"> <span class="price-label">Regular Price:</span> <span class="price"  > Rs.200.00 </span> </p>
                                                  <p class="special-price"> <span class="price-label">Special Price</span> <span class="price"  > Rs.150.00 </span> </p>
                                              </div>
                                          </div>
                                          <div class="rating">
                                              <div class="ratings">
                          ...
                          <div class="item-inner">
                              <div class="product-block">
                                  <div class="product-image"> <a href="product_detail.html">
                                      <figure class="product-display">
                                          <div class="sale-label sale-top-left">Sale</div>
                                          <img src="products_images/mgs-img.png" class="lazyOwl product-mainpic" alt="Product image" style="display: block;"> <img class="product-secondpic" alt="Product image" src="products_images/mgs-img.png"> </figure>
                                  </a> </div>
                                  <div class="product-meta">
                                      <div class="product-action"> <a class="addcart" href="shopping_cart.html"> <i class="icon-shopping-cart">&nbsp;</i> Add to cart </a> <a class="wishlist" href="wishlist.html"> <i class="icon-heart">&nbsp;</i> </a> <a href="quick_view.html" class="quickview"> <i class="icon-zoom">&nbsp;</i> </a> </div>
                                  </div>
                              ...
                              <div class="item-info">
                                  <div class="info-inner">
                                      <div class="item-title"> <a href="product_detail.html" title="Retis lapen casen"> Metal Gear Solid - The Phantom Pain</a> </div>
                                      <div class="item-content">
                                          <div class="item-price">
                                              <div class="price-box"> <span class="regular-price"  > <span class="price">Rs.1200.00</span> </span> </div>
                                          </div>
                                          <div class="rating">
                                              <div class="ratings">
                                                  <div class="rating-box">
                      ...
                      <div class="item">
                          <div class="item-inner">
                              <div class="item-img">
                                  <div class="product-block">
                                      <div class="product-image"> <a href="product_detail.html">
                                          <figure class="product-display">
                                              <div class="new-label new-top-left">New</div>
                                              <img src="products_images/mortalkombat-img.png" class="lazyOwl product-mainpic" alt="Product image" style="display: block;"> <img class="product-secondpic" alt="Product image" src="products_images/mortalkombat-img.png"> </figure>
                                      </a> </div>
                                      <div class="product-meta">
                                          <div class="product-action"> <a class="addcart" href="shopping_cart.html"> <i class="icon-shopping-cart">&nbsp;</i> Add to cart </a> <a class="wishlist" href="wishlist.html"> <i class="icon-heart">&nbsp;</i> </a> <a href="quick_view.html" class="quickview"> <i class="icon-zoom">&nbsp;</i> </a> </div>
                                      </div>
                              ...
                              <div class="item-info">
                                  <div class="info-inner">
                                      <div class="item-title"> <a href="product_detail.html" title="Ut tincidunt tortor"> Mortal Kombat X</a> </div>
                                      <div class="item-content">
                                          <div class="item-price">
                                              <div class="price-box">
                                                  <p class="old-price"> <span class="price-label">Regular Price:</span> <span class="price"  > Rs.800.00 </span> </p>
                                                  <p class="special-price"> <span class="price-label">Special Price</span> <span class="price"  > Rs.600.00 </span> </p>
                                              </div>
                                          </div>
                                          <div class="rating">
                                              <div class="ratings">
                      ...
                      <div class="item">
                          <div class="item-inner">
                              <div class="item-img">
                                  <div class="product-block">
                                      <div class="product-image"> <a href="product_detail.html">
                                          <figure class="product-display">
                                              <div class="new-label new-top-left">New</div>
                                              <img src="products_images/witcher-img.png" class="lazyOwl product-mainpic" alt="Product image" style="display: block;"> <img class="product-secondpic" alt="Product image" src="products_images/witcher-img.png"> </figure>
                                      </a> </div>
                                      <div class="product-meta">
                                          <div class="product-action"> <a class="addcart" href="shopping_cart.html"> <i class="icon-shopping-cart">&nbsp;</i> Add to cart </a> <a class="wishlist" href="wishlist.html"> <i class="icon-heart">&nbsp;</i> </a> <a href="quick_view.html" class="quickview"> <i class="icon-zoom">&nbsp;</i> </a> </div>
                                      </div>
                              ...
                              <div class="item-info">
                                  <div class="info-inner">
                                      <div class="item-title"> <a href="product_detail.html" title="Ut tincidunt tortor"> Witcher 3</a> </div>
                                      <div class="item-content">
                                          <div class="item-price">
                                              <div class="price-box">
                                                  <p class="old-price"> <span class="price-label">Regular Price:</span> <span class="price"  > Rs.1200.00 </span> </p>
                                                  <p class="special-price"> <span class="price-label">Special Price</span> <span class="price"  > Rs.800.00 </span> </p>
                                              </div>
                                          </div>
                                          <div class="rating">
                                              <div class="ratings">
                          ...
                          <div class="item-inner">
                              <div class="product-block">
                                  <div class="product-image"> <a href="product_detail.html">
                                      <figure class="product-display">
                                          <div class="new-label new-top-left">New</div>
                                          <img src="products_images/bloodborne-img.png" class="lazyOwl product-mainpic" alt="Product image" style="display: block;"> <img class="product-secondpic" alt="Product image" src="products_images/bloodborne-img.png"> </figure>
                                  </a> </div>
                                  <div class="product-meta">
                                      <div class="product-action"> <a class="addcart" href="shopping_cart.html"> <i class="icon-shopping-cart">&nbsp;</i> Add to cart </a> <a class="wishlist" href="wishlist.html"> <i class="icon-heart">&nbsp;</i> </a> <a href="quick_view.html" class="quickview"> <i class="icon-zoom">&nbsp;</i> </a> </div>
                                  </div>
                              ...
                              <div class="item-info">
                                  <div class="info-inner">
                                      <div class="item-title"> <a href="product_detail.html" title="Stablished fact reader"> Bloodborne</a> </div>
                                      <div class="item-content">
                                          <div class="item-price">
                                              <div class="price-box">
                                                  <p class="old-price"> <span class="price-label">Regular Price:</span> <span class="price"  > Rs.500.00 </span> </p>
                                                  <p class="special-price"> <span class="price-label">Special Price</span> <span class="price"> Rs.450.00 </span> </p>
                                              </div>
                                          </div>
                                          <div class="rating">
                                              <div class="ratings">
              ...
              <div class="slider-items slider-width-col4">
                <div class="item">
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="product-block">
                        <div class="product-image"> <a href="product_detail.html">
                          <figure class="product-display">
                            <div class="new-label new-top-left">New</div>
                            <img src="products_images/mugs-img.png" class="lazyOwl product-mainpic" alt="Product image" style="display: block;"> <img class="product-secondpic" alt="Product image" src="products_images/mugs-img.png"> </figure>
                          </a> </div>
                        <div class="product-meta">
                          <div class="product-action"> <a class="addcart" href="shopping_cart.html"> <i class="icon-shopping-cart">&nbsp;</i> Add to cart </a> <a class="wishlist" href="wishlist.html"> <i class="icon-heart">&nbsp;</i> </a> <a href="quick_view.html" class="quickview"> <i class="icon-zoom">&nbsp;</i> </a> </div>
                        </div>
                    ...
                    <div class="item-info">
                      <div class="info-inner">
                        <div class="item-title"> <a href="product_detail.html" title="Ut tincidunt tortor"> Mug Printing</a> </div>
                        <div class="item-content">
                          <div class="item-price">
                            <div class="price-box">
                              <p class="old-price"> <span class="price-label">Regular Price:</span> <span class="price"  > Rs.700.00 </span> </p>
                              <p class="special-price"> <span class="price-label">Special Price</span> <span class="price"  > Rs.650.00 </span> </p>
                            </div>
                          </div>
                          <div class="rating">
                            <div class="ratings">
                ...
                <div class="item">
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="product-block">
                        <div class="product-image"> <a href="product_detail.html">
                          <figure class="product-display">
                            <div class="new-label new-top-left">New</div>
                            <img src="products_images/framedphoto-img.png" class="lazyOwl product-mainpic" alt="Product image" style="display: block;"> <img class="product-secondpic" alt="Product image" src="products_images/framedphoto-img.png"> </figure>
                          </a> </div>
                        <div class="product-meta">
                          <div class="product-action"> <a class="addcart" href="shopping_cart.html"> <i class="icon-shopping-cart">&nbsp;</i> Add to cart </a> <a class="wishlist" href="wishlist.html"> <i class="icon-heart">&nbsp;</i> </a> <a href="quick_view.html" class="quickview"> <i class="icon-zoom">&nbsp;</i> </a> </div>
                        </div>
                    ...
                    <div class="item-info">
                      <div class="info-inner">
                        <div class="item-title"> <a href="product_detail.html" title="Ut tincidunt tortor"> Photo Framing</a> </div>
                        <div class="item-content">
                          <div class="item-price">
                            <div class="price-box">
