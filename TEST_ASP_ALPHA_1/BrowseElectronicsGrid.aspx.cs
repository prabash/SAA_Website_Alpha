...
namespace TEST_ASP_ALPHA_1
{
    public partial class BrowseElectronicsGrid : System.Web.UI.Page
    {
        ...
        {
            var slideShowDetails = new ItemsModel().GetSlideShowDetails(ItemType.Electronics);
        ...
        {
            var gridDetails = new ItemsModel().GetItemDetails(ItemType.Electronics, ItemSortBy.NameAsc, 18);
